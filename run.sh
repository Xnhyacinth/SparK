...
for com in "${coms[@]}"
  ...
  for ratio in "${ratios[@]}"
    ...
    python metri.py --results_dir output000_0.65_0.0/results/Meta-Llama-3-8B-Instruct --compress_ratio ${ratio} --compress_q com --tem 0.0 --com_channel ${com} #--value_compress_ratio 0.3 #--threshold_ratio ${xxx} #--pooling_ratio ${xxx}
    # python me.py --results_dir output000_0.65_0.0/results/Llama-3.1-8B-Instruct --compress_ratio ${ratio} --compress_q com --tem 0.0 --com_channel ${com} 
    done 
  done