...
(
  for dataset in $dataset_list
    do
      ...
      CUDA_VISIBLE_DEVICES=${gpus} python -u eval.py --dataset longbench --data_dir ${dataset} --model ${model_name_or_path} --press_name ${press_name} --compression_ratio 0 --device "auto" --temperature ${temperature} --save_dir output ${extra_args}
    done
