...
def main():
    ...
    image = "reg.docker.alibaba-inc.com/aii/aistudio:aistudio-174191480-1014817440-1741765905440"
    # image = "reg.docker.alibaba-inc.com/aii/aistudio:aistudio-170515433-4044009197-1739954018887"
    # image = "reg.docker.alibaba-inc.com/aii/aistudio:aistudio-181308526-191039718-1746704757598"
    ...
    job = PytorchJobBuilder(source_root='./', 
                           command='bash run7.sh',
                           main_file='',
                           master=master,
                           worker=worker,
                           km_conf=km_conf,
                           k8s_app_name="codegpt",
                           tag="type=7-kv_0.75,basemodel=llama3-8b",
                           k8s_priority="low",
                           platform="kubemaker",
                           rdma=1, #必填，且值必须等于1
