...
for press in "${press_names[@]}"; 
  do
    bash test0.sh llama3-8b-inst 1 0.4 snap_adathink 0,1 0.0 0.0 0.7555
    bash test0.sh llama3-8b-inst 1 0.5 snap_adathink 0,1 0.0 0.0 0.7555
    bash test0.sh llama3-8b-inst 1 0.6 snap_adathink 0,1 0.0 0.0 0.7555
    bash test0.sh llama3-8b-inst 1 0.7 snap_adathink 0,1 0.0 0.0 0.7555
    bash test0.sh llama3-8b-inst 1 0.8 snap_adathink 0,1 0.0 0.0 0.7555

    bash test1.sh llama3-8b-inst 1 0.4 snap_adathink 0,1 0.0 0.0 0.7555
    bash test1.sh llama3-8b-inst 1 0.5 snap_adathink 0,1 0.0 0.0 0.7555
    bash test1.sh llama3-8b-inst 1 0.6 snap_adathink 0,1 0.0 0.0 0.7555
    bash test1.sh llama3-8b-inst 1 0.7 snap_adathink 0,1 0.0 0.0 0.7555
    bash test1.sh llama3-8b-inst 1 0.8 snap_adathink 0,1 0.0 0.0 0.7555
    # echo ${press}
    # bash test1.sh llama3-8b-inst 1 0.5 snap_adathink 0,1 0.0 0.0 0.755
    done
