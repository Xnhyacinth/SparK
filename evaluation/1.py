...
# 读取 CSV 文件
df = pd.read_csv('/modelopsnas/modelops/468440/kvpress/output000_0.7554_0.0/results/Meta-Llama-3-8B-Instruct/comress_questions/0.0/2048/results.csv')  # 替换为你的 CSV 文件路径
